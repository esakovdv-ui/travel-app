...
Таблица: [staff.motrip.ru — воронка](https://docs.google.com/spreadsheets/d/1hgznwftwCCB9RRsLzVfm8jSKjAk8irZNruiIYBWgLMQ/edit) (листы `Staff · *` в том же файле, что воронка подбора).

Обновляется каждый час (GitHub Actions **Sync staff funnel sheet**).

| Лист | Что внутри |
|------|------------|
| **Staff · Воронка** | Этапы строками: посетители, сессии, целевые действия (reaches), CR |
| **Staff · По неделям** | Те же этапы, недели колонками, числа = посетители |
| **Staff · Справочник** | ID целей, фильтр URL, поля Битрикса |
