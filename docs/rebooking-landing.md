...
| Параметр | Значение |
|----------|----------|
| **Production URL** | `https://motrip.ru/rebooking` |
...
CSV-колонки: `order,cert,name,people,kids,kid1,kid2,kid3,price,nights,date`.  
Переменная `REBOOKING_BASE_URL` (default: `https://motrip.ru/rebooking`).
...
```html
<iframe
  src="https://motrip.ru/rebooking?order=МГТ-2025-04821&cert=СЕРТ-77412&name=Иванов%20Иван%20Иванович&people=3&kids=1&kid1=7&price=185000&nights=10&date=2026-07-14"
...
Или в Vue/React: `` `:src="'https://motrip.ru/rebooking' + location.search"` `` — если родительская страница уже содержит все нужные параметры.
...
```
https://motrip.ru/rebooking?order=МГТ-2025-04821&cert=СЕРТ-77412&name=Иванов%20Иван%20Иванович&people=3&kids=1&kid1=7&price=185000&nights=10&date=2026-07-14
```

### Минимальный (только order)

```
https://motrip.ru/rebooking?order=TEST-001
```

### Негативный (ошибка)

```
https://motrip.ru/rebooking
https://motrip.ru/rebooking?cert=СЕРТ-77412
```

### С UTM

```
https://motrip.ru/rebooking?order=МГТ-2025-04821&cert=СЕРТ-77412&name=Иванов%20Иван%20Иванович&people=2&price=150000&nights=7&date=2026-08-01&utm_source=email&utm_campaign=rebooking_test
```
...
| Параметр | Значение |
|----------|----------|
| **URL** | `https://motrip.ru/rebooking-admin` |
