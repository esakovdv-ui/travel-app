...
function HelpTab({ onClick }: { onClick: () => void }) {
  return (
    ...
    >
      {/* Тот же самолётик, которым лендинг обозначает «Оставляете заявку»:
          кнопка ведёт ровно туда, и знак портала лучше свежего. Прежний «?»
          читался как справка и был кругом внутри круглой кнопки. */}
      <svg className={styles.helpTabIcon} width="18" height="18" viewBox="0 0 256 256" fill="currentColor" aria-hidden="true">
